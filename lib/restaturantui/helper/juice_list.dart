                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: (widget.categoryListNew[index].variant[0]
                                    .addOnQty !=
                                0)
                            ? Row(
                                mainAxisAlignment:
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                          ...
                                          if (value != null) {
                                            setState(() {
                                              widget.categoryListNew[index]
                                                  .variant[0].addOnQty = value;
                                            });
                                          } else {
                                            if (widget.categoryListNew[index]
                                                    .variant[0].addOnQty >
                                                0) {
                                              setState(() {
                                                widget.categoryListNew[index]
                                                    .variant[0].addOnQty = 0;
                                              });
                                            }
                                          }
                                          db
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: (widget.categoryListNew[index]
                                                    .variant[0].addOnQty ==
                                                0)
                                            ? Colors.grey[300]
                                            : kMainColor,
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        '${widget.categoryListNew[index].variant[0].addOnQty}'),
                                  ),
                                  InkWell(
                                    // onTap: incrementItem(),
                                    onTap: () {
