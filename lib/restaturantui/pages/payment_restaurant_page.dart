...
class PaymentRestPageState extends State<PaymentRestPage> {
  ...
  dynamic currency = '';
  PaystackPlugin p = PaystackPlugin();
  ...
  void placedOrder(paymentStatus, paymentMethod) {
    var url = orderplaced;
    Uri myUri = Uri.parse(url);
    print("orderPlace : $paymentMethod");
    print("orderPlace : ${iswallet?'yes':'no'}");
    print("orderPlace : $paymentStatus");
    print("orderPlace : ${cart_id.toString()}");
