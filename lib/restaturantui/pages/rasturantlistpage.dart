    ...
    http.post(myUri, body: {
      ...
      if (value.statusCode == 200) {
        ...
        if (jsonData['status'] == "1") {
          ...
          print("nearStores are : $nearStores");
        } else {
          setState(() {
            isFetchStore = false;
          });
                                    ...
                                    SizedBox(
                                      ...
                                      child: Image.network(
                                        ...
                                        errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                                          ...
                                          return Image.network('https://c.saavncdn.com/256/Shree-Hanuman-Chalisa-Hanuman-Ashtak-Hindi-1992-20230904173628-500x500.jpg',fit: BoxFit.fill,); // Replace 'default_image.png' with your default image asset path
                                        },
                                      ),
                                          ...
                                          Container(
                                            ...
                                            child: Visibility(
                                              visible: (nearStores[index]
                                                  .online_status =="off" || nearStores[index].online_status =="Off" || nearStores[index].online_status == "OFF")
                                                  ? true
                                                  : false,
                                              child:
                                              Container(
  ...
  hitNavigator(BuildContext context, NearStores item) async {
    ...
    if (isCartCount && prefs.getString("res_vendor_id") != null &&
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  Restaurant_Sub(item, widget.currencySymbol)))
          .then((value){
                    getCartCount();
      });
    }
