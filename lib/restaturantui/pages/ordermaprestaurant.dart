...
class OrderMapRest extends StatefulWidget {
  ...
  OrderHistoryRestaurant ongoingOrders;
...
class _OrderMapRestState extends State<OrderMapRest> {
  ...
  orderdetail() async{
    print("order detail Api running");
    SharedPreferences preferences = await SharedPreferences.getInstance();

    var url = orderdetails;
    Uri myUri = Uri.parse(url);
    print("details : ${preferences.getInt('user_id').toString()}");
    print("details : ${widget.ongoingOrders.cart_id}");
      ...
      if (value.statusCode == 200 && value.body != null) {
        {
          ...
          List<OrderHistoryRestaurant> orders = tagObjsJson
              ...
              .toList();
          print("previous order is: ${widget.ongoingOrders}");
          print("refresh orders is : ${orders}");
          setState(() {
