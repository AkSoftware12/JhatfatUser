...
@override
  ...
  print("packaging charges : ${widget.ongoingOrders.packaging_charges}");
    super.initState();
  }
...
//                  ),
                  ...
                  (widget.ongoingOrders.packaging_charges>0)?
                  Container(
                    color: Colors.white,
                    padding: EdgeInsets.symmetric(
                        vertical: 8.0, horizontal: 20.0),
                    child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '${widget.ongoingOrders.packaging_charges.toStringAsFixed(2)}',
                            style: Theme.of(context).textTheme.caption,
                          ),
                        ]),
                  ): Container(),
