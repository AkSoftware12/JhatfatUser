class NearStores{
  ...
  factory NearStores.fromJson(dynamic json) {
    return NearStores(json['vendor_name'], json['vendor_phone'], json['vendor_id'],json['vendor_logo'],json['vendor_category_id'],json['distance'],json['lat'],json['lng'],json['delivery_range'],json['store_open'],json['vendor_loc'],json['opening_time'],json['about'],json['packaging_charges'],json['inrange'],json['duration']);
  }
