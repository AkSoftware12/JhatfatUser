                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Image.network(
                                          '${imageBaseUrl}${e.category_image}',height: 100,
                                          width: 120,
                                      ...
                                      e.category_id == 74?Container():Expanded(
                                        child: Text(
                                          e.category_name,
          ...
          child: Column(
            children: [
              Container(
                ...
                width: size.width/4,
                decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage("assets/cigImage.jpeg"),fit: BoxFit.fill)
                ),
              ),
              SizedBox(
                height: 15,
              ),
              Text("Play store apps aren’t allowed to sell tobacco products ❌ \n Please use the link below to order tobacco products",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 14),textAlign: TextAlign.center,),
              Spacer(),
              GestureDetector(
                onTap: ()=> _launchWhatsapp(),
                child: Padding(
                  padding: const EdgeInsets.only(bottom: 10),
                  child: Text("www.whatsapp.com",style: TextStyle(color: Colors.blue,decoration: TextDecoration.underline)),
                ),
              )
            ],
          ),
