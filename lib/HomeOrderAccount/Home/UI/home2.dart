    ...
    return
      VisibilityDetector(
          ...
          Scaffold(
            ...
            body: admins == null?SpinKitFadingCircle(
                          ...
                          if (detail.uiType == "grocery" ||
                            ...
                            for (int i = 0; i < rest_nearStores.length; i++) {
                              if (rest_nearStores
                                ...
                                SharedPreferences prefs = await SharedPreferences.getInstance();
                                prefs.setString("res_vendor_id",rest_nearStores.elementAt(i).vendor_id.toString());
                                prefs.setString("res_pack_charge",rest_nearStores.elementAt(i).packaging_charges.toString());
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
                          ...
                          return InkWell(
                            onTap: () {
                              ...
                              else
                              {
                                ...
                                Navigator.push(context, MaterialPageRoute
                                  (builder: (context) =>
                                    AppCategory(pickBannerImage[0].vendorCategoryId,pickBannerImage[0].vendorName,
                                        pickBannerImage[0].vendorId, "22")));
                              }
...
//                                            padding: EdgeInsets.symmetric(horizontal: 10.0,vertical: 10.0),
                                  ...
                                  child: Image.network(
                                    ...
                                    errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                                      ...
                                      return Image.network('https://img.freepik.com/premium-vector/default-image-icon-vector-missing-picture-page-website-design-mobile-app-no-photo-available_87543-11093.jpg?w=900',fit: BoxFit.fill,); // Replace 'default_image.png' with your default image asset path
                                    },
                                  ),
                                  ...
                                  // child: imageBaseUrl + subsImage != null
                                  //     ? Image.network(imageBaseUrl + subsImage!) // Display network image if URL is not null
                                  //     : Image.asset('assets/default_image.png'), // Display default image if URL is null

                                  // child: Image.network('https://c.saavncdn.com/256/Shree-Hanuman-Chalisa-Hanuman-Ashtak-Hindi-1992-20230904173628-500x500.jpg'), // Display default image if URL is null
